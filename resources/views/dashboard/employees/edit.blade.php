            ...
            <div class="p-5 border bg-white">
                <form action="/dashboard/employees/{{ $employee->nip }}" method="post">
                    ...
                    <div class="mb-2 mt-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" autofocus value="{{ old('name',$employee->name) }}" required>
                            @error('name')
                    ...
                    <div class="mb-2 row">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control @error('birth_date') is-invalid @enderror" id="datepicker1" name="birth_date" value="{{ old('birth_date',$employee->birth_date) }}" required>
                            @error('birth_date')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="mb-2 row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="institution_1" name="institution_1" value="{{ old('institution_1',$employee->institution_1) }}">
                        </div>
                    </div>
                    <div class="mb-2 row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="institution_2" name="institution_2" value="{{ old('institution_2',$employee->institution_2) }}">
                        </div>
                    </div>
                    <div class="mb-2 row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="institution_3" name="institution_3" value="{{ old('institution_3',$employee->institution_3) }}">
                        </div>
                    </div>
                    ...
                    <div class="mb-2 row">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control @error('nuptk') is-invalid @enderror" id="nuptk" name="nuptk" value="{{ old('nuptk',$employee->nuptk) }}">
                            @error('nuptk')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control @error('join_date') is-invalid @enderror" id="datepicker3" name="join_date" value="{{ old('join_date',$employee->join_date) }}" required>
                            @error('join_date')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
